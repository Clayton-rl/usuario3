...
import com.javanauta.usuario3.infrastructure.repository.EnderecoRepository;
import com.javanauta.usuario3.infrastructure.repository.TelefoneRepository;
...
public class UsuarioService {
    ...
    public EnderecoDTO atualizaEndereco(Long idEndereco, EnderecoDTO dto){
        ...
        Endereco endereco = usuarioConverter.updateEnderco(dto, entity);
    ...
    public EnderecoDTO cadastraEnderco(String token, EnderecoDTO dto){
        String email = jwtUtil.extractEmailToken(token.substring(7));
    ...
    public TelefoneDTO cadastraTelefone(String token, TelefoneDTO dto){
        ...
        Usuario usuario = usuarioRepository.findByEmail(email).orElseThrow(()->
                new ResourceNotFoundException("Email não localizado" + email));
        Telefone entity = usuarioConverter.paraTelefoneEntity(dto, usuario.getId());
